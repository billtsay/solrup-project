...
package com.solrup.persistence.query;
 ...
 */
public class DataFileLuceneResult<K, T extends PersistentBase> extends ResultBase<K, T> {
  ...
  public DataFileLuceneResult(DataStore<K, T> dataStore, Query<K, T> query
