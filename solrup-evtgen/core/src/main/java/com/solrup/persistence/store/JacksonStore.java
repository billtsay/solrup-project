...
import com.solrup.persistence.query.LuceneResult;
import com.solrup.persistence.query.LucenetQuery;

public class JacksonStore<K, T extends PersistentBase>
extends FileBackedDataStoreBase<K, T> implements Configurable {
  ...
  protected Result<K,T> executeQuery(Query<K,T> query) throws IOException {
    return new LuceneResult<>(this, (LucenetQuery<K,T>)query,
