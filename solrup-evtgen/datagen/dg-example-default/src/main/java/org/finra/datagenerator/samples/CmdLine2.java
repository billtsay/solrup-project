 ...
 */
public final class CmdLine2 {

    private CmdLine2() {
        // Do nothing
    }

    private static final Logger log = Logger.getLogger(CmdLine2.class);
    ...
    public static void main(String[] args) {
        ...
        InputStream is = CmdLine2.class.getResourceAsStream("/samplemachine2.xml");
        ...
        consumer.addDataWriter(new DefaultWriter(System.out,
                new String[]{"var_out_V1", "var_out_V2", "var_out_V3", "var_out_V4"}));
