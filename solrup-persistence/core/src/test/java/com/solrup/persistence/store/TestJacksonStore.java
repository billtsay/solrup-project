...
public class TestJacksonStore {
  ...
  protected JacksonStore<String,Employee> employeeStore;
  protected JacksonStore<String,WebPage> webPageStore;
  ...
  protected JacksonStore<String, Employee> createEmployeeDataStore() throws GoraException {
    return DataStoreFactory.getDataStore(
        JacksonStore.class, String.class, Employee.class, conf);
  }

  protected JacksonStore<String, WebPage> createWebPageDataStore() {
